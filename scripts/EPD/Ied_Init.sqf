...
call compile preprocessFileLineNumbers "scripts\EPD\Ied_Settings.sqf";
call compile preprocessFileLineNumbers "scripts\EPD\IED\ExplosionFunctions.sqf";
call compile preprocessFileLineNumbers "scripts\EPD\IED\CreationFunctions.sqf";
call compile preprocessFileLineNumbers "scripts\EPD\IED\ExplosionEffects.sqf";
call compile preprocessFileLineNumbers "scripts\EPD\IED\CreationAuxiliaryFunctions.sqf";
call compile preprocessFileLineNumbers "scripts\EPD\IED\ExplosivesHandler.sqf";
call compile preprocessFileLineNumbers "scripts\EPD\IED\DisarmFunctions.sqf";
call compile preprocessFileLineNumbers "scripts\EPD\IED\DictionaryFunctions.sqf";
call compile preprocessFileLineNumbers "scripts\EPD\IED\TriggerFunctions.sqf";
