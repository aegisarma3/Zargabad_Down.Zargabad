...
iedInitialArray = [
	...
	//["Lakka", 2, 8,  ["West","East"] ],
	//["OreoKastro", "West"],
	["Shahbaz", 16,[90, 100, 0, 0], "West" ],
	["Firuz Baharv", 10,[90, 100, 0, 0], "West" ],
	["The Villa", 10,[90, 100, 0, 0], "West" ],
	["Zargabad", 50,[90, 100, 0, 0], "West" ],
	["Yarum", 12,[90, 100, 0, 0], "West" ],
	["Nango", 25,[90, 100, 0, 0], "West" ],
	["Hazar Bagh", 20,[90, 100, 0, 0], "West" ],
	["Abe Shur Dan", 25,[90, 0, 0, 100], "West" ],
	["IEDMarker", 20,[90, 100, 0, 0], "West" ],
	["IEDMarker_1", 20,[100, 0, 0, 0], "West" ],
	["IEDMarker_2", 20,[100, 0, 0, 0], "West" ],
	["IEDMarker_3", 20,[90, 100, 0, 0], "West" ],
